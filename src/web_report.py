...
def build_report_payload(
    ...
    strategy_screeners: list[dict[str, Any]] | None = None,
    strategy_screener_results: pd.DataFrame | None = None,
    single_screener_catalog: list[dict[str, Any]] | None = None,
    single_screener_results: pd.DataFrame | None = None,
    ...
    return {
        ...
        "strategy_screener_results": _records(single_screener_results if single_screener_results is not None else strategy_screener_results),
